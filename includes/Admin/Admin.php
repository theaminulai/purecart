...
class Admin {
    ...
    public function __construct() {
        ...
        add_filter( 'plugin_action_links_' . PURECART_BASENAME, [ $this, 'action_links' ] );
    }
    ...
    public function register_menus(): void {
        ...
        add_submenu_page( 'purecart-dashboard',
    ...
    /** Enqueue admin CSS/JS on our screens and product pages. */
    public function enqueue_assets( string $hook ): void {
        ...
        wp_enqueue_script( 'purecart-admin', PURECART_URL . 'assets/js/admin.js',   [ 'jquery' ], PURECART_VERSION, true );
