...
import {
  Mail, Globe, DollarSign, Copy, Edit3, FileText, Download as DownloadIcon, RefreshCw,
  Hash, Calendar, Tag, MousePointerClick, UserPlus, CheckCircle, ArrowUpRight, Trash2, CreditCard,
} from "lucide-react";
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from "recharts";
import {
  M3, affiliatesData, affiliateConversions, affiliatePayouts, affiliateLinks,
  affiliateClickTrend, affiliateTopProducts,
} from "../../utils/static-data";
import { TextButton, Card, OutlinedButton, TonalButton, ActionDropdown, FilledButton, ConfirmDialog, Toast } from "../ui";
import type { ToastProps } from "../ui";

export function AffiliateDetailPage({ affiliateId, onBack }: { affiliateId: string; onBack: () => void }) {
