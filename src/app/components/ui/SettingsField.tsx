...
export function SettingsField({ label, desc, type = "text", defaultValue, placeholder }: { label: string; desc?: string; type?: string; defaultValue?: string; placeholder?: string }) {
  return (
