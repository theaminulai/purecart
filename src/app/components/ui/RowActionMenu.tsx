import {
  MoreVertical, FileText, Users, Copy, Layers, Calendar, RotateCcw, Mail, CheckCircle, PauseCircle, XCircle,
} from "lucide-react";
...
export function RowActionMenu({ row, open, onOpen, onClose, onViewDetail, onViewCustomer, onCopyKey, onExtendExpiry, onResetActivations, onSendReminder, onSuspend, onReinstate, onRevoke, onDuplicate }: RowMenuProps) {
