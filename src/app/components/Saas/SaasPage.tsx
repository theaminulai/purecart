...
import {
  Users, BarChart2, UserPlus, Mail, Send, RefreshCw, Repeat, Tag, CheckCircle, Ban,
  ShieldCheck, Trash2, Cloud, Clock, DollarSign, Search, Download as DownloadIcon, XCircle,
} from "lucide-react";
...
import {
  ...
  TextButton, StatusBadge, ActionDropdown, ConfirmDialog, Toast,
} from "../ui";
import type { ActionItem, ToastProps } from "../ui";

export function SaasPage({ onViewDetail }: { onViewDetail: (id: string) => void }) {
