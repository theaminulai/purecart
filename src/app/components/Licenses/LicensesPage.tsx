...
import {
  Calendar, RotateCcw, PauseCircle, CheckCircle, XCircle, Trash2, BarChart2,
  Download as DownloadIcon, Search, Check, Copy,
} from "lucide-react";
import { M3, licensesTableData, DATE_RANGE_OPTIONS } from "../../utils/static-data";
import { isInDateRange } from "../../utils/date";
import {
  FilledButton, TonalButton, OutlinedButton, FilterChip, Card, StatusBadge,
  RowActionMenu, ConfirmDialog, Toast,
} from "../ui";
import type { ToastProps } from "../ui";

export function LicensesPage({ onDetail, onCustomer, onSummary }: { onDetail: () => void; onCustomer: () => void; onSummary: () => void }) {
