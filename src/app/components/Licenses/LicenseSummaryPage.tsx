...
import {
  M3, licensesByProduct, licenseIssuedTrend, licensesByPlan, activationRateByProduct,
  topCustomersByLicense, recentLicenseActivity,
} from "../../utils/static-data";
import { TextButton, FilledButton, Card, SectionTitle } from "../ui";

export function LicenseSummaryPage({ onBack, onViewAll }: { onBack: () => void; onViewAll: () => void }) {
