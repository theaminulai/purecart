...
import { ShoppingCart, CheckCircle, Activity, DollarSign, Mail } from "lucide-react";
import { BarChart, Bar, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from "recharts";
import { M3, cartTrendData, topAbandonedProducts, emailSeqPerf } from "../../utils/static-data";
import { TextButton, KpiCard, Card, SectionTitle } from "../ui";

export function AbandonedCartAnalyticsPage({ onBack }: { onBack: () => void }) {
