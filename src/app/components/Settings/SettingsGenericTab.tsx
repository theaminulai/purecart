...
import { SettingsToggleField, SettingsSelectField, SettingsField, FilledButton } from "../ui";

export function SettingsGenericTab({ name, onSave }: { name: string; onSave: () => void }) {
