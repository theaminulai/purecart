import {
  Key, Filter, AlertCircle, Download, Copy, Bell, BarChart2, Repeat, Layers, Calendar,
  Globe, Mail, CheckCircle, Users, Clock, DollarSign, UserPlus, ShoppingCart, Activity,
  Send, Settings, Shield, Ban, FileText, CreditCard, Download as DownloadIcon,
} from "lucide-react";
import {
  LineChart, Line, PieChart, Pie, Cell, XAxis, YAxis, CartesianGrid,
  Tooltip, Legend, ResponsiveContainer,
} from "recharts";
import { M3, mrrData, licenseStatusData, recentLicenses, recentDownloads, expiringLicenses } from "../../utils/static-data";
import type { Page } from "../../utils/static-data";
import { StatCard, Card, SectionTitle, StatusBadge, TextButton, Toast } from "../ui";
