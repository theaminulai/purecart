...
export function CollapsibleSection( {
	...
	return (
		<Card className="p-4">
			...
			{ open && (
				<div
					className="mt-3 pt-3 flex flex-col divide-y"
					style={ {
						borderTop: `1px solid ${ M3.outlineVariant }`,
						// Tailwind v4's divide-y border-color defaults to
						// currentColor (no more gray-200 fallback like v3),
						// so without this the dividers pick up whatever text
						// color cascades down instead of the M3 outline gray.
