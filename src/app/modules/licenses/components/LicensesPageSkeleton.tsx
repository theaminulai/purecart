...
/**
 * Loading fallback for LicensesPage, shown by the <Suspense> boundary around
 * it in AppRoutes for the true first load this session only. Mirrors the
 * real page's shape — header, 4-card KPI strip, filter bar, 9-column table.
 *
 * @since 1.0.0
 */
