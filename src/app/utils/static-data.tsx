import {
  ...
  Users, ShoppingCart, Shield, BarChart2, Settings,
  CheckCircle, Bell, CreditCard, Mail, XCircle, UserPlus,
  Ban, PauseCircle, ArrowUpRight,
} from "lucide-react";
...
export const NAV_SCHEMA: Array<{ id: Page; icon: React.ElementType; label: string; moduleKey: string | null; dividerBefore?: boolean }> = [
...
export const DATE_RANGE_OPTIONS = ["Today", "This week", "This month", "Last 3 months", "Last year"];
...
export const paymentHistory: Record<string, Array<{ date: string; amount: string; method: string; status: string }>> = {
  "SUB-001": [
...
export const PRODUCTS_LIST = ["Plugin Pro", "Theme Bundle", "SaaS Connector", "Security Module", "Analytics Add-on", "Update Manager"];
...
export const saasDetailUsers: Record<string, Array<{
...
export const saasBilling: Record<string, Array<{
...
export const saasActivity: Record<string, Array<{
...
export const saasUsageMetrics: Record<string, {
...
export const affiliateConversions: Record<string, Array<{
...
export const affiliatePayouts: Record<string, Array<{
...
export const affiliateLinks: Record<string, Array<{
...
export const affiliateClickTrend: Record<string, Array<{ month: string; clicks: number; conversions: number }>> = {
  "AFF-001": [
...
export const affiliateTopProducts: Record<string, Array<{ product: string; conversions: number; revenue: string; pct: number }>> = {
  "AFF-001": [
...
export const RULE_TYPES    = ["rate-limit","geo-block","ip-list","signature","validation"] as const;
export const RULE_ACTIONS  = ["block","throttle","challenge","reject"] as const;
export const BLOCK_DURATIONS = ["24 hours","7 days","30 days","Permanent"] as const;
export const SEVERITIES    = ["low","medium","high","critical"] as const;

export const SETTINGS_TABS = ["Modules","Licensing","Downloads","Updates","Subscriptions","SaaS","Affiliates","Abandoned Cart","Security","Emails","Advanced"];
